...
# 
# - Author1 = {"name": "Fabien Maussion", "affiliation": "University of Innsbruck", "email": "fabien.maussion@uibk.ac.at", "orcid": "[https://orcid.org/0000-0002-3211-506X](https://orcid.org/0000-0002-3211-506X)"}
# - Author2 = {"name": "Erik Holmgren", "affiliation": "University of Innsbruck", "email": "erik.holmgren@student.uibk.ac.at", "orcid": ""}
# - Author3 = {"name": "Lindsey Nicholson", "affiliation": "University of Innsbruck", "email": "lindsey.nicholson@uibk.ac.at", "orcid": "[https://orcid.org/0000-0003-0430-7950](https://orcid.org/0000-0003-0430-7950)"}
# - Author4 = {"name": "Lizz Ultee", "affiliation": "Georgia Tech", "email": "eultee3@gatech.edu", "orcid": "[https://orcid.org/0000-0002-8780-3089](https://orcid.org/0000-0002-8780-3089)"}
# - Author5 = {"name": "Zora Schirmeister", "affiliation": "University of Innsbruck", "email": "zora.schirmeister@student.uibk.ac.at", "orcid": ""}
# - Author6 = {"name": "Patrick Schmitt", "affiliation": "University of Innsbruck", "email": "patrick.schmitt@student.uibk.ac.at", "orcid": ""}
# - Author7 = {"name": "Lilian Schuster", "affiliation": "University of Innsbruck", "email": "lilian.schuster@student.uibk.ac.at", "orcid": "[https://orcid.org/0000-0003-2101-2070](https://orcid.org/0000-0003-2101-2070)"}

# <h1>Table of Contents<span class="tocSkip"></span></h1>
# <div class="toc"><ul class="toc-item"><li><span><a href="#OGGM-Edu---Jupyter-notebooks-to-learn-and-teach-about-glaciers" data-toc-modified-id="OGGM-Edu---Jupyter-notebooks-to-learn-and-teach-about-glaciers-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>OGGM-Edu - Jupyter notebooks to learn and teach about glaciers</a></span><ul class="toc-item"><li><span><a href="#Authors" data-toc-modified-id="Authors-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Authors</a></span></li><li><span><a href="#Purpose" data-toc-modified-id="Purpose-1.2"><span class="toc-item-num">1.2&nbsp;&nbsp;</span>Purpose</a></span></li><li><span><a href="#Technical-contributions" data-toc-modified-id="Technical-contributions-1.3"><span class="toc-item-num">1.3&nbsp;&nbsp;</span>Technical contributions</a></span></li><li><span><a href="#Methodology" data-toc-modified-id="Methodology-1.4"><span class="toc-item-num">1.4&nbsp;&nbsp;</span>Methodology</a></span></li><li><span><a href="#Results" data-toc-modified-id="Results-1.5"><span class="toc-item-num">1.5&nbsp;&nbsp;</span>Results</a></span></li><li><span><a href="#Funding" data-toc-modified-id="Funding-1.6"><span class="toc-item-num">1.6&nbsp;&nbsp;</span>Funding</a></span></li><li><span><a href="#Keywords" data-toc-modified-id="Keywords-1.7"><span class="toc-item-num">1.7&nbsp;&nbsp;</span>Keywords</a></span></li><li><span><a href="#Citation" data-toc-modified-id="Citation-1.8"><span class="toc-item-num">1.8&nbsp;&nbsp;</span>Citation</a></span></li><li><span><a href="#Suggested-next-steps" data-toc-modified-id="Suggested-next-steps-1.9"><span class="toc-item-num">1.9&nbsp;&nbsp;</span>Suggested next steps</a></span></li><li><span><a href="#Acknowledgements" data-toc-modified-id="Acknowledgements-1.10"><span class="toc-item-num">1.10&nbsp;&nbsp;</span>Acknowledgements</a></span></li></ul></li><li><span><a href="#Setup" data-toc-modified-id="Setup-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Setup</a></span></li><li><span><a href="#Part-1:-Idealized-glacier-experiments" data-toc-modified-id="Part-1:-Idealized-glacier-experiments-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>Part 1: Idealized glacier experiments</a></span><ul class="toc-item"><li><span><a href="#Glacier-flowlines" data-toc-modified-id="Glacier-flowlines-3.1"><span class="toc-item-num">3.1&nbsp;&nbsp;</span>Glacier flowlines</a></span></li><li><span><a href="#Glacier-mass-balance" data-toc-modified-id="Glacier-mass-balance-3.2"><span class="toc-item-num">3.2&nbsp;&nbsp;</span>Glacier mass balance</a></span></li><li><span><a href="#A-first-run" data-toc-modified-id="A-first-run-3.3"><span class="toc-item-num">3.3&nbsp;&nbsp;</span>A first run</a></span></li><li><span><a href="#Experiment:-Influence-of-the-mass-balance-gradient-on-glacier-size" data-toc-modified-id="Experiment:-Influence-of-the-mass-balance-gradient-on-glacier-size-3.4"><span class="toc-item-num">3.4&nbsp;&nbsp;</span>Experiment: Influence of the mass-balance gradient on glacier size</a></span></li><li><span><a href="#Exercise:-Influence-of-glacier-slope" data-toc-modified-id="Exercise:-Influence-of-glacier-slope-3.5"><span class="toc-item-num">3.5&nbsp;&nbsp;</span>Exercise: Influence of glacier slope</a></span></li></ul></li><li><span><a href="#Part-2:-Real-world-glacier-experiments" data-toc-modified-id="Part-2:-Real-world-glacier-experiments-4"><span class="toc-item-num">4&nbsp;&nbsp;</span>Part 2: Real-world glacier experiments</a></span><ul class="toc-item"><li><span><a href="#Glaciers-as-water-resources:-idealized-climate" data-toc-modified-id="Glaciers-as-water-resources:-idealized-climate-4.1"><span class="toc-item-num">4.1&nbsp;&nbsp;</span>Glaciers as water resources: idealized climate</a></span><ul class="toc-item"><li><span><a href="#Setting-the-scene:-glacier-runoff-and-&quot;peak-water&quot;" data-toc-modified-id="Setting-the-scene:-glacier-runoff-and-&quot;peak-water&quot;-4.1.1"><span class="toc-item-num">4.1.1&nbsp;&nbsp;</span>Setting the scene: glacier runoff and "peak water"</a></span></li><li><span><a href="#Setup" data-toc-modified-id="Setup-4.1.2"><span class="toc-item-num">4.1.2&nbsp;&nbsp;</span>Setup</a></span></li><li><span><a href="#Define-the-glacier-we-will-play-with" data-toc-modified-id="Define-the-glacier-we-will-play-with-4.1.3"><span class="toc-item-num">4.1.3&nbsp;&nbsp;</span>Define the glacier we will play with</a></span></li><li><span><a href="#Importing-preprocessed-glacier-data" data-toc-modified-id="Importing-preprocessed-glacier-data-4.1.4"><span class="toc-item-num">4.1.4&nbsp;&nbsp;</span>Importing preprocessed glacier data</a></span></li><li><span><a href="#Interactive-glacier-map" data-toc-modified-id="Interactive-glacier-map-4.1.5"><span class="toc-item-num">4.1.5&nbsp;&nbsp;</span>Interactive glacier map</a></span></li><li><span><a href="#Generating-a-glacier-in-equilibrium-with-climate" data-toc-modified-id="Generating-a-glacier-in-equilibrium-with-climate-4.1.6"><span class="toc-item-num">4.1.6&nbsp;&nbsp;</span>Generating a glacier in equilibrium with climate</a></span></li><li><span><a href="#Climate-change-simulation" data-toc-modified-id="Climate-change-simulation-4.1.7"><span class="toc-item-num">4.1.7&nbsp;&nbsp;</span>Climate change simulation</a></span><ul class="toc-item"><li><span><a href="#Annual-runoff" data-toc-modified-id="Annual-runoff-4.1.7.1"><span class="toc-item-num">4.1.7.1&nbsp;&nbsp;</span>Annual runoff</a></span></li><li><span><a href="#Monthly-runoff" data-toc-modified-id="Monthly-runoff-4.1.7.2"><span class="toc-item-num">4.1.7.2&nbsp;&nbsp;</span>Monthly runoff</a></span></li></ul></li><li><span><a href="#Wrapping-up" data-toc-modified-id="Wrapping-up-4.1.8"><span class="toc-item-num">4.1.8&nbsp;&nbsp;</span>Wrapping up</a></span></li></ul></li><li><span><a href="#Glaciers-as-water-resources:-projection-with-CMIP5" data-toc-modified-id="Glaciers-as-water-resources:-projection-with-CMIP5-4.2"><span class="toc-item-num">4.2&nbsp;&nbsp;</span>Glaciers as water resources: projection with CMIP5</a></span><ul class="toc-item"><li><span><a href="#Climate-downscaling" data-toc-modified-id="Climate-downscaling-4.2.1"><span class="toc-item-num">4.2.1&nbsp;&nbsp;</span>Climate downscaling</a></span></li><li><span><a href="#Projection-run" data-toc-modified-id="Projection-run-4.2.2"><span class="toc-item-num">4.2.2&nbsp;&nbsp;</span>Projection run</a></span></li></ul></li><li><span><a href="#Part-2:-Take-home-points" data-toc-modified-id="Part-2:-Take-home-points-4.3"><span class="toc-item-num">4.3&nbsp;&nbsp;</span>Part 2: Take home points</a></span></li></ul></li><li><span><a href="#References" data-toc-modified-id="References-5"><span class="toc-item-num">5&nbsp;&nbsp;</span>References</a></span></li></ul></div>
...
# 
# The notebook contains code sections that serve as templates, followed by example research questions and suggestions that invite the student to re-run the experiment with updated simulation parameters. This notebook (as well as all other similar notebooks featured on the OGGM-Edu platform) is meant to be used and adapted by instructors to match the topics of a specific lecture or workshop. Interested readers will find more example notebooks on [OGGM-Edu](https://oggm.org/oggm-edu-notebooks/welcome.html).
# 
...
# ## Methodology
# 
# The notebook relies on a number of standard packages of the scientific python ecosytem: [NumPy](https://numpy.org/), [SciPy](https://www.scipy.org/), [xarray](http://xarray.pydata.org/en/stable/index.html), [pandas](https://pandas.pydata.org/), etc. The main tool used for the modelling of glaciers is the Open Global Glacier Model (OGGM, http://oggm.org, https://docs.oggm.org). We also rely on a small number of helper functions (mostly to hide some of the OGGM internals to the readers) from the OGGM-Edu python package. For more details about OGGM-Edu, visit https://edu.oggm.org.
# 
# ## Results
# 
...
# ## Funding
# 
# - Award1 = {"agency": "University of Innsbruck", "award_code": "Förderkreis 1669 – Wissen schafft Gesell schaft", "award_URL": "[https://www.uibk.ac.at/foerderkreis1669](https://www.uibk.ac.at/foerderkreis1669)"}
# - Award2 = {"agency": "Bundesministerium für Bildung und Forschung - BMBF", "award_code": "FKZ 01LS1602A", "award_URL": "[https://www.bmbf.de](https://www.bmbf.de)"}
# 
# 
# ## Keywords
# 
...
# ## Citation
# 
# Maussion, F., Holmgren, E., Nicholson, L., Ultee, L., Schirmeister, Z., Schmitt, P., Schuster, L.. OGGM-Edu - Jupyter notebooks to learn and teach about glaciers. Jupyter Notebook accessed 11.06.2021 at https://github.com/OGGM/EarthCube2021
# 
...
# ## Acknowledgements 
# 
# Thanks to the OGGM and OGGM-Edu developers, and all the open-source tools used in this notebook. Most notably: [NumPy](https://numpy.org/), [SciPy](https://www.scipy.org/), [Matplotlib](https://matplotlib.org/), [pandas](https://pandas.pydata.org/), [GeoPandas](https://geopandas.org/), [xarray](http://xarray.pydata.org/en/stable/index.html)... 
# Thanks also to EarthCube for the opportunity to share this work.
...
oggm.cfg.initialize_minimal(logging_level='CRITICAL')
# Prevent numerical inaccuracies
oggm.cfg.PARAMS['cfl_number'] = 5e-3
# Store only the relevant variables here
oggm.cfg.PARAMS['store_diagnostic_variables'] = ['volume', 'area', 'length']
...
# 
# This section is inspired from the OGGM-Edu notebooks "[Glacier flowline modelling](https://oggm.org/oggm-edu-notebooks/oggm-edu/flowline_model.html)", "[Ice flow parameters](https://oggm.org/oggm-edu-notebooks/oggm-edu/ice_flow_parameters.html)" and "[Mass-balance gradient](https://oggm.org/oggm-edu-notebooks/oggm-edu/mass_balance_gradients.html)".

# ## Glacier flowlines

# OGGM is a so-called flowline model, which means that the glacier ice flow is assumed to happen along a representative “1.5 dimensional” flowline, as in the image below. Why “1.5D” instead of 1 or 2? Although glacier ice can flow in only one direction along the flowline, each point of the glacier has a geometrical width, which can be different for different points. This means that 1.5D flowline models are able to match the observed area-elevation distribution of true glaciers, and can parametrize how glacier width changes with ice thickness change.
# 
# <img src="https://docs.oggm.org/en/stable/_images/hef_flowline.jpg" width="40%" alt="Image of a flowline">
...
# The `init_flowline` object now contains all geometrical information needed by the model. It can give us access to some glacier attributes, which will be updated through the simulation: 
...
# In this simple example, glaciers will gain mass via solid precipitation (snow/ice) and lose mass via melt. We will implement a glacier mass balance model to account for how much mass is gained or lost at each time step. To learn about mass-balance processes in more detail, visit our [mass-balance notebook](https://oggm.org/oggm-edu-notebooks/oggm-edu/accumulation_and_ablation.html) and this [introduction to Glacier Mass Balance](http://www.antarcticglaciers.org/glacier-processes/mass-balance/introduction-glacier-mass-balance/) on [AntarcticGlaciers.org](http://www.antarcticglaciers.org).
# 
# We will use a simple linear function to describe the mass balance, defined by the [equilibrium line altitude](https://link.springer.com/referenceworkentry/10.1007%2F978-90-481-2642-2_140) (`ELA`, the zone where annual accumulation - mass gain - and ablation - mass loss- are equal) and the gradient (mass-balance change with altitude, `altgrad`, unit [mm yr$^{-1}$ m$^{-1}$]):
...
altgrad = 4  # altitude gradient in mm yr-1 m-1
mb_model = LinearMassBalance(ELA, grad=altgrad)


# The OGGM mass-balance model computes the mass balance for any given altitude (unit: meters of ice per time [m s$^{-1}$], a simplification for the ice dynamics model). Let's compute the *annual* mass balance along the glacier profile:

# In[ ]:


annual_mb = mb_model.get_annual_mb(surface_h) * oggm.cfg.SEC_IN_YEAR
...
plt.text(-7, ELA+30, 'ELA' );


# These values are not too far from observed values of accumulation and melt in many regions of the world.
# 
# **Independant research: can you find out what typical mass-balance gradient values can be measured on various glaciers of the world, and what climate variable(s) are the most relevant for them?**

# ## A first run 

# To let our glacier grow in various climate and topography conditions we need a glacier evolution model. A glacier evolution model is simply a combination of the initial bed topography (the flowline) and the climate (the mass-balance model). Let's build it!
...
# Let's run the model for a number of years (here 600), and store the output
...
# The first year of the simulation sees a big step increase in length and area: this is simply because the mass balance is positive at the top of the glacier, and we go from no glacier at all to a thin, but already 4 km long glacier. After this, the glacier constantly grows until reaching an equilibrium. This happens when the mass gain at the top of the glacier is compensated by mass loss at the tongue.
# 
# Do you see the small steps in length and area (specifically after the year 400)? This is because the length of a glacier in OGGM is defined by grid points of a specific grid size, i.e the step size.
# 
# What does a glacier at equilibrium look like? Let's have a look:
...
# The output of `get_diagnostics()` is a [pandas](https://pandas.pydata.org/) data frame, which is very descriptive. We won't have a look at all output variables today, but here is an overview: 
...
# What does it mean when a glacier is in equilibrium with its climate? It means that its volume doesn't change with time (which we can verify in the plots above), and that the total mass balance (averaged over the glacier area) is approximately equal to zero:
...
# 
# <img src="https://raw.githubusercontent.com/OGGM/glacier-graphics/master/glacier_intro/png/glacier_03.png" width="33%" align="left" alt="OGGM Edu graphics 03">
# <img src="https://raw.githubusercontent.com/OGGM/glacier-graphics/master/glacier_intro/png/glacier_04.png" width="33%" align="left" alt="OGGM Edu graphics 04">
# <img src="https://raw.githubusercontent.com/OGGM/glacier-graphics/master/glacier_intro/png/glacier_05.png" width="33%" align="left" alt="OGGM Edu graphics 05">
# 
...
# Now, a very common misconception is that a glacier which doesn't advance or retreat also doesn't move. We are going to show that our glacier is alive and well, and does move quite a lot even if it's not growing or shrinking!
...
ax = plt.subplot(121)
velocity = geometry.ice_velocity * oggm.cfg.SEC_IN_YEAR
velocity.plot(ax=ax);
plt.legend(); plt.xlabel('Distance along flowline [m]'); plt.ylabel('Ice velocity [m yr$^{-1}$]');
plt.title('Ice velocity along the glacier (m yr$^{-1}$)');
plt.subplot(122)
...
# 
# <img src="https://i1.wp.com/fyfluiddynamics.com/wp-content/uploads/2019/04/tumblr_pktim1sPnF1qckzoqo1_1280.gif" width="40%" align="left" alt="gif of a flowing glacier seen from space">
...
# There are glaciers in many mountain areas of the world. To verify this yourself, we recommend spending a few minutes on the [World Glacier Explorer](https://edu.oggm.org/en/latest/explorer.html), one of OGGM-Edu's web applications.
# 
# In the app, we learned that glaciers can be located in maritime climates (regions with high amounts of precipitation and relatively warm) and in dry climates (rather dry and cold). These climate features can be translated to our simple framework by the mass-balance gradient:
# - A large mass-balance gradient represents high amounts of solid precipitation and high amounts of melt (**maritime climate**)
# - A small mass-balance gradient represents low amounts of solid precipitation and low amounts of melt (**dry climate**)
# 
...
for gradient in gradients:
    ...
    mb_profiles.append(mb_model.get_annual_mb(surface_h) * oggm.cfg.SEC_IN_YEAR)
    glacier_diagnostics.append(glacier_model.get_diagnostics())
    glacier_evolution.append(ds)
    
# Don't worry, this can take some time - but not more than one minute or two!
...
# **Questions to address with an instructor or with independant research:**
# - Visually check the amount of melt at the terminus of the glacier. Compare this with melt values you can find documented for real glaciers (for example, [data from the World Glacier Monitoring Service](https://wgms.ch/latest-glacier-mass-balance-data/) or from scientific publications).
# - Why are all the glaciers symmetrical around the equilibrium line altitude? In the jargon, the ratio of the area above the equilibrium line altitude (ELA) divided by the entire area is called the Accumulation Area Ratio (AAR): here, it is 50%. Compare this with values you can find in the literature, and explain which of the assumptions we used can lead to this rather unusual AAR.
...
# 
# - Accumulation-area ratio (AAR): The ratio, often expressed as a percentage, of the area of the accumulation zone to the area of the glacier. The AAR is bounded between 0 and 1. On many glaciers it correlates well with the climatic mass balance. The likelihood that the climatic mass balance will be positive increases as the AAR approaches 1. (from the [Glossary of glacier mass balance and related terms](https://wgms.ch/downloads/Cogley_etal_2011.pdf))
...
# **Bonus analysis: Temporal evolution of the glaciers**
...
# - Why does one glacier respond much faster compared to another?
...
for gradient, geometry in zip(gradients, glacier_diagnostics):
    (geometry.ice_velocity * oggm.cfg.SEC_IN_YEAR).plot(label='Velocity, grad={}'.format(gradient));
plt.legend(); plt.xlabel('Distance along flowline [m]'); plt.ylabel('Ice velocity (m yr$^{-1}$)');
...
# 
# **Questions to address:**
# - What is the influence of the glacier slope on how large the glacier will be in equilibrium and how fast the glacier responds. Can you explain this?
...
for factor, geometry in zip(factors, glacier_diagnostics):
    (geometry.ice_velocity * oggm.cfg.SEC_IN_YEAR).plot(label='Velocity, factor={}'.format(factor));
plt.legend(); plt.xlabel('Distance along flowline [m]'); plt.ylabel('Ice velocity (m yr$^{-1}$)');
...
# Part 1 explained how to use OGGM to answer theoretical questions about glaciers, using idealized experiments: the effect of a different slope, the concept of the equilibrium line altitude, the mass-balance gradient, etc. Now, how do we use OGGM to explore real glaciers? This section will give us some insights.
# 
# 
# This section is inspired from the OGGM-Edu notebooks "Glaciers as water resources" [part 1](https://oggm.org/oggm-edu-notebooks/oggm-edu/glacier_water_resources.html) and [part 2](https://oggm.org/oggm-edu-notebooks/oggm-edu/glacier_water_resources_projections.html).

# ## Glaciers as water resources: idealized climate
...
# "*If glaciers melt, there won't be water in the mountains anymore*".
# 
# This is a sentence that we often hear from people we meet, or sometimes even in news articles. In fact, the role of glaciers in the hydrological cycle is more complex than that. In this notebook, we will explore this question using idealized climate scenarios applied to real glaciers!

# Before we continue, let's have a look at the expected contribution of glaciers to local streamflow. <a id='runoff-graphic'></a>
# The chart below shows an idealized scenario where first the climate is constant (t$_0$-t$_1$) and the glacier is in equilibrium with its climate. Then a warming occurs (t$_1$-t$_2$) and the glacier begins to lose mass. This graph makes a few very important points, which we will explore together in this notebook.
# 
# 1. When a glacier is in equilibrium, it makes no net contribution to the annual runoff  since the winter uptake of water, in the form of snow, is as large as the summer release through melt.
...
# 3. If climate warms even more, glaciers will continue to lose mass and become significantly smaller. When there isn't much ice left to melt each summer (or when climate stabilizes), their contribution will become smaller, until it becomes zero again.
# 4. In the new equilibrium, the annual basin runoff is the same as before, but the seasonal pattern has changed.
# 
# We will now get back to all these points together, using OGGM!

# <img src="https://raw.githubusercontent.com/OGGM/oggm-edu/master/docs/_static/fig_huss_hock.jpg" width="60%" alt="Fig 1 from https://www.nature.com/articles/s41558-017-0049-x">
# 
...
# 
# ...and virtually any glacier you can find the RGI ID from (consult the [GLIMS viewer](https://www.glims.org/maps/glims) for IDs)! Large glaciers may need longer simulations to see changes. For less uncertain model calibration parameters, we also recommend to pick one of the many reference glaciers [listed here](https://github.com/OGGM/oggm-sample-data/blob/master/wgms/rgi_wgms_links_20200415.csv), where we make sure that observations of mass balance are better matched. 
# 
# 
...
# ### Importing preprocessed glacier data

# Here we import all necessary data of the glacier. OGGM provides six different levels of preprocessed glacier directories. Each directory contains all the needed information for one glacier, like the geometry of the flowlines or the climate information for the mass-balance. For a detailed description of the different preprocessed levels you can look [here](https://docs.oggm.org/en/stable/input-data.html#processing-levels) and the raw data sources are listed [here](https://docs.oggm.org/en/stable/input-data.html#raw-data-sources).
# 
# The import can take up to a few minutes on the first call because of the download of the required data:
...
(gv.Polygons(sh).opts(fill_color=None, color_index=None) * gts.tile_sources['EsriImagery'] *
 gts.tile_sources['StamenLabels']).opts(width=800, height=500, active_tools=['pan', 'wheel_zoom'])


# As described above, glaciers in the OGGM world are "1.5 dimensional" along their flowline:
...
tasks.run_with_hydro(gdir,  # Run on the selected glacier
                     ...
                     run_task=run_constant_climate_with_bias,  # which climate scenario? See below for more examples
...
# - We run the model for 400 years (as defined by our control temperature time series)
# - The model runs with a constant climate based on the average over 21 years (2 times `halfsize` + 1) for the period 1999-2019
# - We apply a cold bias of -2°C. Indeed, Hintereisferner is in strong disequilibrium with the current climate and this cold bias is needed to make the glacier grow (more on this later)
...
# *Tip: you can click on a variable and show its attribute with the "page" button on the right.*
# 
...
# In this scenario, the glacier would melt almost entirely (it loses about 90% of its volume). Note also that the glacier continues to adjust after the temperature has stabilized. 
# 
# **What are the implications for downstream runoff?**

# #### Annual runoff

# As glaciers retreat, they contribute to sea-level rise (visit the [World Glaciers Explorer](https://edu.oggm.org/en/latest/explorer.html) OGGM-Edu app for more information!). This is however not what we are interested in for this notebook. Instead we will explore an important local impact of glaciers: their impact on streamflow.  
# 
...
# 
# *Note that we convert the annual runoff from kilos to mega-tonnes (Mt)*
...
# - Liquid precipitation on- and off-glacier (the latter being zero at the year of largest glacial extent, in this example at the start of the simulation)

# In[ ]:


f, ax = plt.subplots(figsize=(10, 6));
df_runoff.plot.area(ax=ax, color=sns.color_palette('rocket')); plt.xlabel('Years');
plt.ylabel('Runoff (Mt)'); plt.title(rgi_id);
...
# 
# *Hint: compare the results to the [idealised runoff graphic that we introduced at the beginning of this chapter](#runoff-graphic)*
# 
...
# But be aware, something is a bit wrong with this plot (some of you may have noticed: maximum melt happens in the fall, which is unusual). That's because the OGGM coordinates are hydrological months - a side effect of using a so called mass balance year (or [water year](https://en.wikipedia.org/wiki/Water_year)), which begins in October and ends in September (i.e. encompasses the entire accumulation and ablation season). 
# 
# We have to correct for this by shifting the months forward:
...
tot_precip = (ds_roll['liq_prcp_off_glacier_monthly'] + ds_roll['liq_prcp_on_glacier_monthly'] +
              ds_roll['snowfall_off_glacier_monthly'] + ds_roll['snowfall_on_glacier_monthly'])
...
# 
# Note that the hydrological interpretation is very glacier-specific. So if you change the glacier by using another *rgi_id*, you also might need to adapt the notebook explanation in teaching!
# 
...
# Now let's conclude this notebook by reproducing now this famous plot by [Huss & Hock (2018)](https://www.nature.com/articles/s41558-017-0049-x) with our data.
# 
# <img src="https://raw.githubusercontent.com/OGGM/oggm-edu/master/docs/_static/fig_huss_hock.jpg" width="60%" alt="Fig 1 from https://www.nature.com/articles/s41558-017-0049-x">
# 
# *Graphic from [Huss & Hock (2018)](https://www.nature.com/articles/s41558-017-0049-x)*
...
# ## Glaciers as water resources: projection with CMIP5

# You have now learned how to simulate and analyse a specific glacier under an idealized climate. We will now take this a step further and simulate two different glaciers, located in different climatic regions, forced with CMIP5 ([Coupled Model Intercomparison Project 5](https://www.wcrp-climate.org/wgcm-cmip/wgcm-cmip5)) climate projections.
# 
...
# Before we run our simulation we have to process the climate data for the glacier i.e. we downscale it: (This can take some time)
...
# Unlike for Hintereisferner, these projections indicate that the annual runoff will increase in all the scenarios for the first half of the century. The higher RCP scenarios can reach "peak water" later in the century, since the excess melt can continue to increase. For the lower RCP scenarios on the other hand, the glacier might be approaching a new equilibrium, which reduces the runoff earlier in the century [(Rounce et. al., 2020)](https://www.frontiersin.org/articles/10.3389/feart.2019.00331/full). After "peak water" is reached (RCP2.6: ~2055, RCP8.5: ~2070 in these projections), the annual runoff begins to decrease. This decrease occurs because the shrinking glacier is no longer able to support the high levels of melt.
...
# - An EGU [CryoBlog post](https://blogs.egu.eu/divisions/cr/2021/03/05/glaciers-water-supply-climate-change/) about the role of glaciers in the hydrological cycle
# - [AntarcticGlaciers.org](http://www.antarcticglaciers.org/): a fantastic resource to learn about glaciers.
